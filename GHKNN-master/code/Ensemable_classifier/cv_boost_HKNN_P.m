	...
	for i=1:length(k_nn_l)
		for j =1:length(lammda_l)
		    ...
		    for fold=1:nfolds
		        ...
		        [Predict_label_f,Score_f] = bootstrap_EnClassifierHKNN_np( train_X_S, tr_y, test_X_S, te_y, k_nn,lammda,1,m,0.5);
	            ...
	            fprintf('CV K_nn=%d,lammda =%d,m=%d,MCC=%d \n',k_nn,lammda,m,meanMCC);
