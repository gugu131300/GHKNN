function [Predict_label_f,Score_f] = bootstrap_EnClassifierGHKNN_np( train_feature, train_label, test_feature, test_label, k_nn,lammda,gamma,beta,type,rate, m,threshold_T)
...
for i=1:Num_share
	...
	[Predict_label_f1,distance_s,dec_values1] = ghknn(sub_train_feature_1,sub_train_label_1,test_feature,k_nn,lammda,gamma,beta,type);
