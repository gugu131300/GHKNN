function [Predict_label_f,Score_f] = bootstrap_EnClassifierHKNN_np( train_feature, train_label, test_feature, test_label, k_nn,lammda,rate, m,threshold_T)
...
for i=1:Num_share
	...
	[Predict_label_f1,distance_s,dec_values1] = hknn(sub_train_feature_1,sub_train_label_1,test_feature,k_nn,lammda);
