function [Predict_label_f,Score_f] = bootstrap_EnClassifierSVM_np( train_feature, train_label, test_feature, test_label, CG_parameter,rate, m,threshold_T)
...
% CG_parameter: - The parameter c and g in SVM training.  In tihs function, it is the string of parameter c and g. (for example: CG_parameter = '-c 1 -g 1 -b 1')
...
for i=1:Num_share
	...
	Score_ff=[Score_ff,dec_values1(:,1)];
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
